...
const Nav = () => {
  return (
    <div className="relative z-40 mx-6 ">
      <nav className=" rounded-2xl px-6 absolute w-full flex justify-between text-white text-xl font-light  py-2 bg-white/1 backdrop-blur-sm  shadow-[2px_2px_5px_2px_rgba(0,0,0,0.3)] mt-3">
        <div className="Left">
          <Image src="/logo.png" alt="img" height={50} width={80} className="hover:scale-110 opacity-80"/>
        </div>
        <div className="midpart flex gap-6  pl-50 ">
        ...
        <div className="right flex">
          ...
          <input
            type="text"
            placeholder="   Search "
            className=" border  rounded-md shadow inline-flex cursor-pointer opacity-80 bg-black/20 "
          />
